...
public static class ClaimsEndpoints
{
    public static IEndpointRouteBuilder MapClaimsEndpoints(this IEndpointRouteBuilder endpoints)
    {
        ...
        apiGroup.MapPost(ConstantsConfiguration.EndpointsCreateClaim, EndpointsHandler.CreateClaimAsync)
        ...
        apiGroup.MapPost(ConstantsConfiguration.EndpointsAssignClaim, EndpointsHandler.AssignClaimAsync)
        ...
        apiGroup.MapDelete(ConstantsConfiguration.EndpointsRevokeClaim, EndpointsHandler.RevokeClaimAsync)
        ...
        apiGroup.MapDelete(ConstantsConfiguration.EndpointsDeleteClaim, EndpointsHandler.DeleteClaimAsync)
