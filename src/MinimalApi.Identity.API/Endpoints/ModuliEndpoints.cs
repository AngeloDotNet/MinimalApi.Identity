...
public static class ModuliEndpoints
{
    public static IEndpointRouteBuilder MapModuliEndpoints(this IEndpointRouteBuilder endpoints)
    {
        ...
        apiGroup.MapPost(ConstantsConfiguration.EndpointsCreateModule, EndpointsHandler.CreateModuleAsync)
        ...
        apiGroup.MapPost(ConstantsConfiguration.EndpointsAssignModule, EndpointsHandler.AssignModuleAsync)
        ...
        apiGroup.MapDelete(ConstantsConfiguration.EndpointsRevokeModule, EndpointsHandler.RevokeModuleAsync)
        ...
        apiGroup.MapDelete(ConstantsConfiguration.EndpointsDeleteModule, EndpointsHandler.DeleteModuleAsync)
