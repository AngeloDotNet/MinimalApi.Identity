...
public static class EndpointsHandler
{
    public static async Task<IResult> GetAllHandlerAsync([FromServices] ILicenseService licenseService, HttpContext httpContext)
    {
        ...
        return Results.Ok(await licenseService.GetAllLicensesAsync(httpContext.RequestAborted));
    }
        ...
        HttpContext httpContext)
    {
        ...
        return Results.Ok(await licenseService.CreateLicenseAsync(inputModel, httpContext.RequestAborted));
    }
        ...
        HttpContext httpContext)
    {
        ...
        return Results.Ok(await licenseService.AssignLicenseAsync(inputModel, httpContext.RequestAborted));
    }
        ...
        HttpContext httpContext)
    {
        ...
        return Results.Ok(await licenseService.RevokeLicenseAsync(inputModel, httpContext.RequestAborted));
    }
        ...
        HttpContext httpContext)
    {
        ...
        //return Results.Ok(result);
        return Results.Ok(await licenseService.DeleteLicenseAsync(inputModel, httpContext.RequestAborted));
    }
}