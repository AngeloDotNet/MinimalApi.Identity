...
namespace MinimalApi.Identity.Migrations.Migrations
{
    ...
    [Migration("20250730204816_InitialMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MinimalApi.Identity.Core.Entities.AuthPolicy", b =>
                {
                    ...
                    b.Property<string>("PolicyPermissions")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("MinimalApi.Identity.Core.Entities.EmailSendingStatus", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MinimalApi.Identity.Core.Entities.EmailSendingStatus", b =>
                {
                    b.HasOne("MinimalApi.Identity.Core.Entities.EmailSending", "EmailSending")
                        .WithMany()
                        .HasForeignKey("EmailSendingId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MinimalApi.Identity.Core.Entities.TypeEmailSending", "TypeEmailSending")
                        .WithMany("EmailSendingsStatus")
            ...
            modelBuilder.Entity("MinimalApi.Identity.Core.Entities.TypeEmailSending", b =>
                {
                    b.Navigation("EmailSendingsStatus");
                });
